      ...
      <h1> Menu </h1>
        ...
        <div className="personasContainer">
          <div className="persona">
              <img title="adopt a neutral, non-autonomous persona!" onClick={e => artificialCharacter(e.target.id)} id='off' style={(charTone=='off')? {'filter': 'none'} : {'filter': 'grayscale()'}} alt="hades" className="personaImgs" src="/Images/static/hades.png"></img>
              <div>
                  <p>Hades</p>
          ...
          <div className="persona">
              <img title="adopt a fully autonomous and creative persona, he interacts as he likes!" onClick={e => artificialCharacter(e.target.id)} id='abstract' style={(charTone=='abstract')? {'filter': 'none'} : {'filter': 'grayscale()'}} alt="Apollo" className="personaImgs" src="/Images/static/apollo.png"></img>
              <div>
                  <p>Apollo</p>
          ...
          <div className="persona">
              <img title="adopt an autonomous and succinct persona, customize how often she interacts!" onClick={e => artificialCharacter(e.target.id)} id='realistic' style={(charTone=='realistic')? {'filter': 'none'} : {'filter': 'grayscale()'}} alt="themis" className="personaImgs" src="/Images/static/themis.png"></img>
              <div>
                  <p>Themis</p>
